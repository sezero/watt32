 ...
 *
 * Hence all vendors except djgpp, MinGW, Cygwin and HighC seems to be wrong by one.
 * MSDN has this to say:
 * (https://msdn.microsoft.com/en-us/library/t3ayayh1.aspx?f=255&MSPPError=-2147217396)
 *
 *   The perror and strerror functions use the _sys_errlist array and _sys_nerr,
 *   the number of elements in _sys_errlist, to process error information.
 */
...
#define GEN_WARNING "/*\n" \
                    " * THIS FILE WAS GENERATED BY %%WATT_ROOT%%\\%s\n" \
                    " * at %.24s.\n"      \
                    " * DO NOT EDIT.\n%s" \
                    " *\n"
