...
#if (DOSX & POWERPAK) && defined(BORLAND386)  /* Rest of file */
...
/*
 * Message from BCC32.exe v5.5:
 *   Warning W8002 powerpak.c 108: Restarting compile using assembly in function ReadRealMem
 *
 * But my TASM32 ver 5.3 is not able to assemble the instructions generated by BCC32:
 *   Assembling file:   build\borland\flat\powerpak.ASM  to  BUILD\BORLAND\FLAT\powerpak.obj
 *   **Error** build\borland\flat\powerpak.ASM(1332) Undefined symbol: unsigned
 *   **Error** build\borland\flat\powerpak.ASM(1454) Undefined symbol: unsigned
 *
 * Hence create the below functions elsewhere later.
 */
