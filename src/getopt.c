...
enum watt_optmode watt_optmode = GETOPT_UNIX;
...
/**\todo
 */
int W32_CALL watt_getopt_long (int argc, char *const *argv,
                               const char *opt_str,
...
int W32_CALL _w_watt_getopt_long (int argc, wchar_t *const *argv,
