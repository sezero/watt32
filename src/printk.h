...
#include <stdarg.h>
  ...
  #include <unistd.h>
    ...
    defined(__DMC__) || defined(__BORLANDC__) || defined(__MINGW32__)
  #include <process.h>
#endif
...
extern int   _fputsk    (const char *buf, FILE *stream);
  ...
  extern int MS_CDECL _printk (_Printf_format_string_ const char *fmt, ...)
  W32_ATTR_PRINTF (1, 2);

  extern int MS_CDECL _snprintk (char *buf, int len, _Printf_format_string_ const char *fmt, ...)
  W32_ATTR_PRINTF (3, 4);
#endif
